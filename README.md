...
- This problem is partially related to Intlayer. I think the main issue is that the plugin is too old and is no longer maintained for newer versions of Remix.js and ReactRouter.
